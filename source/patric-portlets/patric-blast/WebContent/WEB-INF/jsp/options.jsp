<h2 align="center">BLAST Search main parameters</h2>

<dl>
	<dt><b><a name = histogram>HISTOGRAM</a></b></dt>
	<dd>Display a histogram of scores for each search; default
		is yes. (See parameter H in the BLAST Manual).</dd>
		
	<dt><b><a name = descriptions>DESCRIPTIONS</a></b></dt>
	<dd>Restricts the number of short descriptions of matching
		...
		manual page).  See also EXPECT and CUTOFF.</dd>
		
	<dt><b><a name = alignments>ALIGNMENTS</a></b></dt>
	<dd>Restricts database sequences to the number specified for
		...
		(See parameter B in the BLAST Manual).</dd>
		
	<dt><b><a name = expect>EXPECT</a></b></dt>
	<dd>
	...
	<dt><b><a name = cutoff>CUTOFF</a></b></dt>
	<dd>
		...
		can be more intuitively managed using EXPECT.</dd>
		
	<dt><b><a name = matrix>MATRIX</a></b></dt>
	<dd> 
		...
		returns an error response.</dd>
		
	<dt><b><a name = strand>STRAND</a></b></dt>
	<dd> 
	...
	top or bottom strand of the query sequence.</dd>
	
	<dt><b><a name = filter>FILTER</a></b></dt>
	<dd> 
	...
	<dt><b><a name = ncbi-gi>NCBI-gi</a></b></dt>
	<dd> 

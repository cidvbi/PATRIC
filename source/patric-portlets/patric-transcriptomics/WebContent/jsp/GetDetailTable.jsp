...
%><%@ page import="java.io.OutputStream" %><%
	...
	if(request.getParameter("_tablesource")!= null && request.getParameter("_tablesource").equals("Table_Cell")){
		...
		condition.put("sortParam", request.getParameter("sort").toString());
    	
    	if(request.getParameter("_tablesource")!= null && request.getParameter("_tablesource").equals("TranscriptomicsGeneFeature")){

...
function getCartWindow(workspace_type) {
	var Page = $Page, btn = Page.getCartSaveButton();
	...
	signup_popup = Ext.create('Ext.Window', {
		...
		items : [{
			...
			items : [{
				...
				xtype : 'displayfield',
				value : '<a target="_blank" ' + 'href="https://www.patricbrc.org/portal/portal/patric/MyAccount/PATRICUserPortletWindow?_jsfBridgeViewId=%2Fjsf%2Findex.xhtml&amp;action=1">Sign up</a> ' + 'for a PATRIC account to save custom sets of workspace genomes and more <br> ' + '<a target="_blank" href="http://enews.patricbrc.org/faqs/workspace-faqs/registration-faqs/" style="float: right;padding: 0px 20px;">Learn more</a>'
			}, {
				xtype : 'imagecomponent',
				src : '/patric/images/horizonal_rule_OR_302x9.png'
			}, {
				...
				xtype : 'displayfield',
				value : 'As Guest, your Workspace items persists until you close your browser.<br> ' + '<input style="width:120px; height:20px; top: 1px; padding: 0px 13px; position:relative; left: 180px; cursor: pointer;" ' + 'onclick="javascript:setPopupStatus(\'' + workspace_type + '\');return false;" value="Continue as Guest" class="login-button" />'
			}]
		}],
		listeners : {
			hide : function() {
